...
function initPrebid() {
    ...
    var sizeBidder = (bidder) => {
        if (bidder && Object.keys(bidder)) {
            ...
            if (bidder["sunmedia"] && Object.keys(bidder["sunmedia"]) && Object.keys(bidder["sunmedia"]).length) {
                let placementCode_sunMedia;
                if (isPhone && bidder["sunmedia"]["mobile"]) {
                    placementCode_sunMedia = bidder["sunmedia"]["mobile"]["pid"];
                } else if (bidder["sunmedia"]["desktop"]) {
                    placementCode_sunMedia = bidder["sunmedia"]["desktop"]["pid"];
                }
                const sunMedia = {
                    bidder: "richaudience",
                    params: {
                        pid: placementCode_sunMedia,
                        supplyType: "site"
                    }
                }
                arrayBidder.push(sunMedia);
            }
            return arrayBidder
        }
    }
